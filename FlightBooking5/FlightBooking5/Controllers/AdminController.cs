...
namespace FlightBooking5.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(FlightBooking5Context context, RoleManager<IdentityRole> roleManager, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public IActionResult ChangeRole(string userName)
        {
            ...
            if (user == null)
            {
                // Handling when the user cannot be found
                return NotFound();
            }

            // Get a list of the user's current roles
